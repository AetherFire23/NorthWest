...
public class MinusButtonObject : GameObjectWrapper, IInitializable
{
    public readonly MinusButtonObjectScript MinusButtonScript;
    private readonly RoomTabBar _roomTabsContainerObject;
    public MinusButtonObject(MinusButtonObjectScript minusButtonScript,
        RoomTabBar roomTabsContainerObject) : base(minusButtonScript)
    {
