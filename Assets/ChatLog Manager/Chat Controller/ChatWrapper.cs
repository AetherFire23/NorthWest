...
{
    public class ChatWrapper : GameObjectWrapper
    {
        public ChatScript ChatBehaviour;
        public ChatWrapper(ChatScript chatScript) : base(chatScript) // devrons rendre private I guess, remet en question la pertinence du unityobject
        {
