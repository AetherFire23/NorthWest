...
//{
//    public class GameStateManager : IInitializable // Wrapper instead
//    {
...
//        public GameStateManager(ClientCalls clientCalls)
//        {
//            _client = clientCalls;
//        }
...
//            CurrentGameState = GetFirstGameState(); 
//        }
...
//        public async UniTask<GameState> GetNextGameState()
//        {
//            DateTime? currentTimeStamp = CurrentGameState.TimeStamp;
//            GameState newGameState = await _client.GetGameState(this.PlayerUID, currentTimeStamp);
